...
#define UDA1380_CLK_INIT_VALUE (EN_ADC | EN_DEC | EN_DAC | EN_INT | ADC_CLK | DAC_CLK | PLL_12K5_25K | SYS_DIV_384FS)
...
#define UDA1380_IBUSCFG_INIT_MASK (SEL_SOURCE | SFORI | SFORO)
...
#define UDA1380_MVOLCTR_INIT_VALUE 0x5555
#define UDA1380_MVOLCTR_INIT_MASK (MVCL | MVCR)
//Mix Volume, Maximum
#define UDA1380_MIXVOLCTR_INIT_VALUE (VC1_dB(VCx_dB_MIN) | VC2_dB(VCx_dB_MAX))
...
#define UDA1380_ADC_INIT_VALUE  (VGA_CTRL_dB(VGA_CTRL_dB_MAX) | EN_DCFIL)
#define UDA1380_ADC_INIT_MASK (ADCPOL_INV | VGA_CTRL | SKIP_DCFIL | EN_DCFIL)
