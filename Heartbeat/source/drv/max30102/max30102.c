...
max30102_state_t max30102_trigger_temp_read()
{
	...
	uint8_t mask = data;
	//Set bit for triggering temp read
...
max30102_state_t max30102_get_temperature_c(float* temp)
{
	...
	{
		//Recover integre and frac, calculate temp
